...
public class RookInitializer implements PieceInitializer {
  ...
  public Piece initialize(Color color, String id) {
    ...
    combinedValidators.add(new OrValidator(List.of(Moves.horizontalMove(), Moves.straightMove())));

    return new Piece(id, color, PieceType.ROOK, new AndValidator(combinedValidators));
  }
}
