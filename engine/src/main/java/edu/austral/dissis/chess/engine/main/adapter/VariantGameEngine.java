...
public class VariantGameEngine implements GameEngine {
  private final Adapter adapter;

  public VariantGameEngine(GameState gameState) {
    adapter = new Adapter(gameState);
  }

  public VariantGameEngine() {
    GameState gameState = CheckersGame.createCheckersNormalGame();
    adapter = new Adapter(gameState);
  }
